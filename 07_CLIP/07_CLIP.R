...
ggplot() + 
  geom_sf(data = clip_polygon, fill = "green", alpha = 0.5) +
  geom_sf(data = combined_clipped, fill = "lightblue", color = "black") +  # Plot the clipped shapefiles
  theme_minimal() + 
  labs(title = "Clipped Shapefiles", x = "Longitude", y = "Latitude") +
